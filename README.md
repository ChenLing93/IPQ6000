...
## 特别提示 [![](https://img.shields.io/badge/-大量魔改个人免责声明-FFFFFF.svg)](#特别提示-)
...
- 固件默认管理地址：`192.168.5.1` 默认用户：`root` 默认密码：`password或者无`
...
6. 编译大概需要3-5小时，编译完成后在仓库主页 [Releases](https://github.com/ChenLing93/IPQ6000/releases) 对应 Tag 标签内下载固件
